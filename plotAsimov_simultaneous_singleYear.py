...
def plotAsimov_sim(asimovDataModel, asimovPhysicalModel, modelName, physicalModel, obsName, fstate, observableBins, recobin):
    ...
    for fState in fStates:
        for bin in range(nBins):
            ...
            if (obsName!='mass4l'): trueH_asimov[fState+"_Bin"+str(bin)] = w_asimov.function("n_exp_final_binch"+channel[fState]+"_ch"+str(recobin+1)+"_proc_trueH"+fState+"Bin"+str(bin))
            else: trueH_asimov[fState+"_Bin"+str(bin)] = w_asimov.function("n_exp_final_binch"+channel[fState]+"_proc_trueH"+fState+"Bin"+str(bin))
            print (fState+"_Bin"+str(bin))
            print ("n_exp_final_binch"+channel[fState]+"_ch"+str(recobin+1)+"_proc_trueH"+fState+"Bin"+str(bin))
            print (trueH_asimov[fState+"_Bin"+str(bin)].getVal())
        ...
        for bin in range(nBins):
            if (bin==recobin): n_trueH_asimov[fState] = trueH_asimov[fState+"_Bin"+str(bin)].getVal()
            else: n_trueH_otherfid_asimov[fState] += trueH_asimov[fState+"_Bin"+str(bin)].getVal()
    ...
    #     n_trueH_asimov[fState] += n_trueH_asimov[fState]
    #     n_trueH_otherfid_asimov[fState] += n_trueH_otherfid_asimov[fState]
    #     n_fakeH_asimov[fState] += n_fakeH_asimov[fState]
    #     n_out_trueH_asimov[fState] += n_out_trueH_asimov[fState]
    #     n_zz_asimov[fState] += n_zz_asimov[fState]
    #     n_qqzz_asimov[fState] += n_qqzz_asimov[fState]
    #     n_zjets_asimov[fState] += n_zjets_asimov[fState]
    ...
    # n_zz_asimov["4l"] = 0.0
    # n_qqzz_asimov["4l"] = 0.0
    # n_trueH_asimov["4l"] += n_trueH_asimov["4l"]
    # n_trueH_otherfid_asimov["4l"] += n_trueH_otherfid_asimov["4l"]
    # n_fakeH_asimov["4l"] += n_fakeH_asimov["4l"]
    # n_out_trueH_asimov["4l"] += n_out_trueH_asimov["4l"]
    # n_zjets_asimov["4l"] += n_zjets_asimov["4l"]
    # n_qqzz_asimov["4l"] += n_zz_asimov["4l"]
    # n_zz_asimov["4l"] += n_zz_asimov["4l"]
    ...
    for fState in fStates:
        for bin in range(nBins):
            if(obsName!='mass4l'):
                trueH_modelfit[fState+"_Bin"+str(bin)] = w_modelfit.function("n_exp_final_binch"+channel[fState]+"_ch"+str(recobin+1)+"_proc_trueH"+fState+"Bin"+str(bin))
                trueH_modelfit[fState+"_Bin"+str(bin)] = w_modelfit.function("n_exp_final_binch"+channel[fState]+"_ch"+str(recobin+1)+"_proc_trueH"+fState+"Bin"+str(bin))
            else:
                trueH_modelfit[fState+"_Bin"+str(bin)] = w_modelfit.function("n_exp_final_binch"+channel[fState]+"_proc_trueH"+fState+"Bin"+str(bin))
                trueH_modelfit[fState+"_Bin"+str(bin)] = w_modelfit.function("n_exp_final_binch"+channel[fState]+"_proc_trueH"+fState+"Bin"+str(bin))
            print (fState+"_Bin"+str(bin))
            print ("n_exp_final_binch"+channel[fState]+"_ch"+str(recobin+1)+"_proc_trueH"+fState+"Bin"+str(bin))
            print (trueH_modelfit[fState+"_Bin"+str(bin)].getVal())
        ...
        for bin in range(nBins):
            if (bin==recobin): n_trueH_modelfit[fState] = trueH_modelfit[fState+"_Bin"+str(bin)].getVal()
            else: n_trueH_otherfid_modelfit[fState] += trueH_modelfit[fState+"_Bin"+str(bin)].getVal()
    ...
    #     n_trueH_modelfit[fState] += n_trueH_modelfit[fState]
    #     n_trueH_otherfid_modelfit[fState] += n_trueH_otherfid_modelfit[fState]
    #     n_fakeH_modelfit[fState] += n_fakeH_modelfit[fState]
    #     n_out_trueH_modelfit[fState] += n_out_trueH_modelfit[fState]
    #     n_zz_modelfit[fState] += n_zz_modelfit[fState]
    #     n_qqzz_modelfit[fState] += n_qqzz_modelfit[fState]
    #     n_ggzz_modelfit[fState] += n_ggzz_modelfit[fState]
    #     n_zjets_modelfit[fState] += n_zjets_modelfit[fState]
    #
    # n_trueH_modelfit["4l"] = 0.0
    # n_trueH_otherfid_modelfit["4l"] = 0.0
    # n_fakeH_modelfit["4l"] = 0.0
    ...
    # n_qqzz_modelfit["4l"] = 0.0
    # n_ggzz_modelfit["4l"] = 0.0
    # n_trueH_modelfit["4l"] += n_trueH_modelfit["4l"]
    # n_trueH_otherfid_modelfit["4l"] += n_trueH_otherfid_modelfit["4l"]
    # n_fakeH_modelfit["4l"] += n_fakeH_modelfit["4l"]
    # n_out_trueH_modelfit["4l"] += n_out_trueH_modelfit["4l"]
    # n_zjets_modelfit["4l"] += n_zjets_modelfit["4l"]
    # n_zz_modelfit["4l"] += n_zz_modelfit["4l"]
    # n_qqzz_modelfit["4l"] += n_qqzz_modelfit["4l"]
    # n_ggzz_modelfit["4l"] += n_ggzz_modelfit["4l"]
    ...
    if (fstate=="4l"):
        datacut = ''
        for fState in fStates:
            if(obsName!='mass4l'): datacut += "CMS_channel==CMS_channel::ch"+channel[fState]+"_ch"+str(recobin+1)+" || "
            else: datacut += "CMS_channel==CMS_channel::ch"+channel[fState]+" || "
        ...
        for bin in range(nBins):
            ...
            for fState in fStates:
                if(obsName!='mass4l'): comp_otherfid += "shapeSig_trueH"+fState+"Bin"+str(bin)+"_ch"+channel[fState]+"_ch"+str(recobin+1)+","
                else: comp_otherfid += "shapeSig_trueH"+fState+"Bin"+str(bin)+"_ch"+channel[fState]+","
        ...
        for fState in fStates:
            if(obsName!='mass4l'):
                ...
                comp_out += "shapeBkg_out_trueH_ch"+channel[fState]+","
                comp_fake += "shapeBkg_fakeH_ch"+channel[fState]+","
                comp_zz += "shapeBkg_bkg_ggzz_ch"+channel[fState]+",shapeBkg_bkg_qqzz_ch"+channel[fState]+","
                comp_zx += "shapeBkg_bkg_zjets_ch"+channel[fState]+","
        ...
        if(obsName!='mass4l'):
            ...
            datacut += "CMS_channel==CMS_channel::ch"+channel[fstate]+" || "
        datacut = datacut.rstrip(" || ")
        data = data.reduce(RooFit.Cut(datacut))
        data.plotOn(mass)
        sim.plotOn(mass,RooFit.LineColor(kRed), RooFit.ProjWData(data,True))
        ...
        for bin in range(nBins):
            ...
            if(obsName!='mass4l'):
                ...
                comp_otherfid += "shapeSig_trueH"+fstate+"Bin"+str(bin)+"_ch"+channel[fstate]+","
        comp_otherfid = comp_otherfid.rstrip(',')
