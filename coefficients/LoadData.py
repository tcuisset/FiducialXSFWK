...
dirMC_94 = '/eos/user/a/atarabin/MC_samples'
...
# ]
SamplesMC_94 = [
'ZH_HToZZ_4LFilter_M125_2017.root'
]
...
for i in range(0,len(SamplesMC_94)):
    ...
    if (h_nevents): nEvents[sample] = h_nevents.Integral() #not really nevents. Will work for now
